...
nUtentesInstituicao( Instituicao ) :- solucoes( IDU, ( servico( IDS, _, Instituicao, _ ), consulta( _, IDU, _, IDS, _ ) ), R ),
...
nServicosInstituicao( Instituicao ) :- solucoes( IDS, servico( IDS, _, Instituicao, _ ), R ),
	comprimento( R, N ),
	write( 'Na instituicao '),write( Instituicao ),write( ' foram prestados '),write( N ),write( ' serviços.'),nl.
...
rendimentoInstituicaoEntre( Instituicao, Data1, Data2 ) :- solucoes( Custo, ( servico( IDS, _, Instituicao, _ ), 
																			  consulta( Data, _, _, IDS, Custo), 
																			( Data1 @=< Data ), ( Data @=< Data2 ) ),
																			 R ),
	somarLista( R, G ),
	write( 'Rendimento da instituição ' ),write( Instituicao ),write( ' entre ' ),
	write( Data1 ),write( ' e ' ),write( Data2 ),write( ' é de ' ),write( G ),nl.
